...
/**
 * Generated class for the Sala_3Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sala-3',
  templateUrl: 'sala-3.html',
})
export class Sala_3Page {
  conteudo = [];
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Sala_3Page');
    this.getSalas();
  }
